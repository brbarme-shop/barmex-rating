...
var (
	db = postgresql.NewPostgreSqlRepository("host=localhost port=5432 user=rating_user password=rating_pwd dbname=rating_db sslmode=disable")
)
...
func addRating(c *gin.Context) {
	...
	err = rating.PutRating(c.Request.Context(), ratingInput, db)
	if err != nil {
